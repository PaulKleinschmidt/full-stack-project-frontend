...
var config = {
  apiOrigins: {
    production: 'https://floating-lake-78080.herokuapp.com',
...
var updateFavorite = function updateFavorite(data) {
  return $.ajax({
    url: config.apiOrigin + '/favorites/' + data.favorite.id,
    method: 'PATCH',
    headers: {
...
var showFavorites = __webpack_require__(20);
var showUpdatedFavorite = __webpack_require__(37);
var showSongs = __webpack_require__(11);
var favoritesApi = __webpack_require__(7);

var userFavorites = 0;

var checkFavorites = function checkFavorites(data) {
  if (data === undefined) {
    userFavorites -= 1;
  } else {
...
var displayFavoriteForms = function displayFavoriteForms() {
  if (userFavorites === 0) {
    $('#show-favorites').hide();
...
var createFavoriteSuccess = function createFavoriteSuccess(data) {
  userFavorites += 1;
  displayFavoriteForms();
  $('#message').text('new favorite made');
  $('#show-favorites').show();
  // const showFavoriteHtml = showCreatedFavorite ({ favorites: data })
  var showSongsHtml = showSongs({ songs: data.songs, favorite: data.favorite.song.title });
  $('.content').append(showSongsHtml);
};

var createFavoriteFailiure = function createFavoriteFailiure(data) {
  $('#message').text('failed');
};

var showFavoritesSuccess = function showFavoritesSuccess(data) {
  $('#message').empty();
  ...
  var showFavoritesHtml = showFavorites({ favorites: data.favorites });
  $('.content').append(showFavoritesHtml);
};

var showFavoritesFailiure = function showFavoritesFailiure(data) {
  $('#message').text('failiure');
};

var deleteFavoriteSuccess = function deleteFavoriteSuccess(data) {
  $('#message').empty();
  // clear forms
  // $('#delete-favorite')[0].reset()
  checkFavorites();

  favoritesApi.showFavorites().then(showFavoritesSuccess).catch(console.error());
};

var deleteFavoriteFailiure = function deleteFavoriteFailiure(data) {
...
var updateFavoriteSuccess = function updateFavoriteSuccess(data) {
  ...
  var showUpdatedFavoriteHtml = showUpdatedFavorite({ favorites: data });
  $('.content').append(showUpdatedFavoriteHtml);
};

var updateFavoriteFailiure = function updateFavoriteFailiure(data) {
...
module.exports = {
  createFavoriteFailiure: createFavoriteFailiure,
  createFavoriteSuccess: createFavoriteSuccess,
  showFavoritesSuccess: showFavoritesSuccess,
  showFavoritesFailiure: showFavoritesFailiure,
  deleteFavoriteSuccess: deleteFavoriteSuccess,
  deleteFavoriteFailiure: deleteFavoriteFailiure,
  updateFavoriteSuccess: updateFavoriteSuccess,
  updateFavoriteFailiure: updateFavoriteFailiure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n  <div class=\"show-data\" data-id=\""
    ...
    + "</h2>\n\n    <h4 class=\"show-artist\">by: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.artist : stack1), depth0))
    + "</h4>\n\n    <h5 class=\"show-id\">Song ID# "
    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</h5>\n\n    <form id=\"create-favorite\">\n      <input type=\"submit\" name=\"Add To Favorites\" value=\"Favorite\" class=\"favorite-button\">\n      <input type=\"text\" name=\"favorite[song_id]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" id=\"song-id\" placeholder=\"Song-ID\" style=\"display: none\">\n    </form>\n\n    </div>\n\n";
...
var favoriteEvents = __webpack_require__(38);
var songEvents = __webpack_require__(40);
var artistEvents = __webpack_require__(43);
...
var store = __webpack_require__(2);
var favoritesApi = __webpack_require__(7);
var favoritesUi = __webpack_require__(9);
...
var signInSuccess = function signInSuccess(data) {
  ...
  $('#sign-up')[0].reset();
  $('#auth-message').empty();
  favoritesApi.showFavorites(data).then(favoritesUi.checkFavorites).catch(console.error());
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n  <div class=\"show-data\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <h2 class=\"show-title\">Title: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.song : stack1)) != null ? stack1.title : stack1), depth0))
    + "</h2>\n\n    <h4 class=\"show-artist\">Artist: "
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.song : stack1)) != null ? stack1.artist : stack1), depth0))
    + "</h4>\n\n    <h4 class=\"show-id\">favorite id# "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</h4>\n\n    <form id=\"delete-favorite\">\n      <div class=\"dropdown\">\n      <input type=\"submit\" name=\"submit\" value=\"Delete favorite\" class=\"delete-button\">\n      <input type=\"number\" name=\"favorite[id]\" id=\"delete-by-favorite-id\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" style=\"display: none\">\n  </div>\n    </form>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.favorites : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n  <div class=\"show-data\" data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " Has Been Updated</h2>\n    <h2 class=\"show-title\">Title: "
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.favorite : depth0)) != null ? stack1.song : stack1)) != null ? stack1.title : stack1), depth0))
    + "</h2>\n\n    <h4 class=\"show-artist\">Artist: "
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.favorite : depth0)) != null ? stack1.song : stack1)) != null ? stack1.artist : stack1), depth0))
    + "</h4>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
var showDeletedFavorite = __webpack_require__(39);

var onCreateFavorite = function onCreateFavorite(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createFavorite(data).then(ui.createFavoriteSuccess).catch(ui.createFavoriteFailure);
};

var onShowFavorites = function onShowFavorites(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.showFavorites(data).then(ui.showFavoritesSuccess).catch(ui.showFavoritesFailiure);
};
...
var onDeleteFavorite = function onDeleteFavorite(event) {
  ...
  event.preventDefault();
  api.deleteFavorite(data).then(ui.deleteFavoriteSuccess).catch(ui.deleteFavoriteFailiure);
};

var onUpdateFavorite = function onUpdateFavorite(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.updateFavorite(data).then(ui.updateFavoriteSuccess).catch(ui.updateFavoriteFailiure);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),blockParams[0][0],{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n\n";
...
var onShowSongs = function onShowSongs(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.showSongs(data).then(ui.showSongsSuccess).catch(ui.showSongsFailiure);
};
...
var showSongs = function showSongs(data) {
  return $.ajax({
...
var showSongsSuccess = function showSongsSuccess(data) {
  $('#message').text('Songs:');
  $('.content').empty();
...
var showSongsFailiure = function showSongsFailiure(data) {
  $('#message').text('failiure');
};

module.exports = {
  showSongsSuccess: showSongsSuccess,
  showSongsFailiure: showSongsFailiure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onCreateArtist = function onCreateArtist(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createArtist(data).then(ui.createArtistSuccess).catch(ui.createArtistFailure);
};

var onShowArtists = function onShowArtists(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.showArtists(data).then(ui.showArtistsSuccess).catch(ui.showArtistsFailiure);
};
...
var createArtist = function createArtist(data) {
  return $.ajax({
...
var showArtists = function showArtists(data) {
  return $.ajax({
    url: config.apiOrigin + '/artists/',
    method: 'GET',
    headers: {
...
var createArtistSuccess = function createArtistSuccess(data) {
  $('#message').text('new artist made');
};

var createArtistFailiure = function createArtistFailiure(data) {
  $('#message').text('failed');
};

var showArtistsSuccess = function showArtistsSuccess(data) {
  $('#message').text('success');
};
var showArtistsFailiure = function showArtistsFailiure(data) {
  $('#message').text('failiure');
};

module.exports = {
  createArtistFailiure: createArtistFailiure,
  createArtistSuccess: createArtistSuccess,
  showArtistsSuccess: showArtistsSuccess,
  showArtistsFailiure: showArtistsFailiure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
